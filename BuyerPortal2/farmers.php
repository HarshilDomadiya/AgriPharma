    ...
    <div class="container mt-5">
        <div class="row">
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class='col-12 col-sm-12 col-md-6 col-lg-3 col-xl-3 mb-4'>
                        <div class='card border-dark border h-100'>
                            <div class='card-body'>
                                <h5 class='card-title text-center'><img src='$icon' style='margin-bottom: 10px;'></h5>
                                <h4 class='card-subtitle mb-2 text-center'>$farmer_name</h4>
                                <p class='card-text text-center'>$farmer_district, $farmer_state<br><br>
                                    <a href='farmer-profile.php?id=$farmer_id' class='btn border-dark border' style='background-color:#FFD700;color:black'>View Profile</a>
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                echo "<div class='col-12 text-center'><h3>No farmers found</h3></div>";
            }
            ?>
        </div>
    </div>
